...
func (x *SensorOutput) GetImuOuput() *ImuOutput {
	if x, ok := x.GetSensorOutput().(*SensorOutput_ImuOuput); ok {
		return x.ImuOuput
	}
	return nil
}
...
func (x *SensorOutput) GetRpmOuput() *RpmOutput {
	if x, ok := x.GetSensorOutput().(*SensorOutput_RpmOuput); ok {
		return x.RpmOuput
	}
	return nil
}

func (x *SensorOutput) GetLuxOutput() *LuxOutput {
	if x, ok := x.GetSensorOutput().(*SensorOutput_LuxOutput); ok {
		return x.LuxOutput
	}
	return nil
}
...
type SensorOutput_ImuOuput struct {
	ImuOuput *ImuOutput `protobuf:"bytes,8,opt,name=imuOuput,proto3,oneof"`
}
...
type SensorOutput_RpmOuput struct {
	RpmOuput *RpmOutput `protobuf:"bytes,10,opt,name=rpmOuput,proto3,oneof"`
}

type SensorOutput_LuxOutput struct {
	LuxOutput *LuxOutput `protobuf:"bytes,11,opt,name=luxOutput,proto3,oneof"`
}
...
func (*SensorOutput_ImuOuput) isSensorOutput_SensorOutput() {}
...
var file_outputs_wrapper_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x93, 0x05, 0x0a, 0x0c, 0x53, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x4f, 0x75,
	...
	,
...
var file_outputs_wrapper_proto_goTypes = []interface{}{
	...
	(*ImuOutput)(nil),            // 5: protobuf_msgs.ImuOutput
	(*BatterySensorOutput)(nil),  // 6: protobuf_msgs.BatterySensorOutput
	(*RpmOutput)(nil),            // 7: protobuf_msgs.RpmOutput
	(*LuxOutput)(nil),            // 8: protobuf_msgs.LuxOutput
}
var file_outputs_wrapper_proto_depIdxs = []int32{
	...
	5, // 4: protobuf_msgs.SensorOutput.imuOuput:type_name -> protobuf_msgs.ImuOutput
	6, // 5: protobuf_msgs.SensorOutput.batteryOutput:type_name -> protobuf_msgs.BatterySensorOutput
	7, // 6: protobuf_msgs.SensorOutput.rpmOuput:type_name -> protobuf_msgs.RpmOutput
	8, // 7: protobuf_msgs.SensorOutput.luxOutput:type_name -> protobuf_msgs.LuxOutput
