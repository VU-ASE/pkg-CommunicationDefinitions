...
type CameraSensorOutput struct {
	...
	Trajectory []*CameraSensorOutput_Point    `protobuf:"bytes,1,rep,name=trajectory,proto3" json:"trajectory,omitempty"`
...
func (x *CameraSensorOutput) GetTrajectory() []*CameraSensorOutput_Point {
	if x != nil {
		return x.Trajectory
	}
	return nil
...
type CameraSensorOutput_Point struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CameraSensorOutput_Point) Reset() {
	*x = CameraSensorOutput_Point{}
	if protoimpl.UnsafeEnabled {
...
func (x *CameraSensorOutput_Point) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CameraSensorOutput_Point) ProtoMessage() {}

func (x *CameraSensorOutput_Point) ProtoReflect() protoreflect.Message {
	mi := &file_outputs_camera_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CameraSensorOutput_Point.ProtoReflect.Descriptor instead.
func (*CameraSensorOutput_Point) Descriptor() ([]byte, []int) {
	return file_outputs_camera_proto_rawDescGZIP(), []int{2, 0}
}

func (x *CameraSensorOutput_Point) GetX() uint32 {
	if x != nil {
		return x.X
	}
	return 0
...
func (x *CameraSensorOutput_Point) GetY() uint32 {
	if x != nil {
		return x.Y
	}
	return 0
...
var file_outputs_camera_proto_rawDesc = []byte{
	...
	0x75, 0x74, 0x2e, 0x50, 0x6f, 0x69, 0x6e, 0x74, 0x52, 0x0a, 0x74, 0x72, 0x61, 0x6a, 0x65, 0x63,
	0x74, 0x6f, 0x72, 0x79, 0x12, 0x4d, 0x0a, 0x0b, 0x64, 0x65, 0x62, 0x75, 0x67, 0x5f, 0x66, 0x72,
	0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2c, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x62, 0x75, 0x66, 0x5f, 0x6d, 0x73, 0x67, 0x73, 0x2e, 0x43, 0x61, 0x6d, 0x65, 0x72, 0x61,
	0x53, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x2e, 0x44, 0x65, 0x62,
...
func file_outputs_camera_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_outputs_camera_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CameraSensorOutput_Point); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
