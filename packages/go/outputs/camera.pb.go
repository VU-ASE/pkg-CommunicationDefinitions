...
var file_outputs_camera_proto_rawDesc = []byte{
	...
	0x01, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x01, 0x79, 0x1a, 0x4f, 0x0a, 0x0a, 0x44,
	...
	0x62, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x2a, 0x3f, 0x0a,
	0x0f, 0x44, 0x65, 0x74, 0x65, 0x63, 0x74, 0x65, 0x64, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x73,
	0x12, 0x0f, 0x0a, 0x0b, 0x46, 0x49, 0x4e, 0x49, 0x53, 0x48, 0x5f, 0x4c, 0x49, 0x4e, 0x45, 0x10,
	0x00, 0x12, 0x0d, 0x0a, 0x09, 0x4f, 0x46, 0x46, 0x5f, 0x54, 0x52, 0x41, 0x43, 0x4b, 0x10, 0x01,
	0x12, 0x0c, 0x0a, 0x08, 0x4f, 0x42, 0x53, 0x54, 0x41, 0x43, 0x4c, 0x45, 0x10, 0x02, 0x42, 0x17,
...
func file_outputs_camera_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_outputs_camera_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CameraSensorOutput_Objects); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_outputs_camera_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
