...
func (x *LuxSensorOutput) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LuxSensorOutput) ProtoMessage() {}

func (x *LuxSensorOutput) ProtoReflect() protoreflect.Message {
	mi := &file_outputs_lux_proto_msgTypes[0]
...
// Deprecated: Use LuxSensorOutput.ProtoReflect.Descriptor instead.
func (*LuxSensorOutput) Descriptor() ([]byte, []int) {
	return file_outputs_lux_proto_rawDescGZIP(), []int{0}
}

func (x *LuxSensorOutput) GetLux() int32 {
	if x != nil {
		return x.Lux
	}
	return 0
...
var file_outputs_lux_proto_rawDesc = []byte{
	...
	0x67, 0x73, 0x22, 0x23, 0x0a, 0x0f, 0x4c, 0x75, 0x78, 0x53, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x4f,
	0x75, 0x74, 0x70, 0x75, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x6c, 0x75, 0x78, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x05, 0x52, 0x03, 0x6c, 0x75, 0x78, 0x42, 0x17, 0x5a, 0x15, 0x61, 0x73, 0x65, 0x2f, 0x70,
...
var file_outputs_lux_proto_goTypes = []interface{}{
	(*LuxSensorOutput)(nil), // 0: protobuf_msgs.LuxSensorOutput
}
