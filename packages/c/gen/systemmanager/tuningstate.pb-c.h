...
#ifndef PROTOBUF_C_systemmanager_2ftuningstate_2eproto__INCLUDED
#define PROTOBUF_C_systemmanager_2ftuningstate_2eproto__INCLUDED
...
typedef struct _ProtobufMsgs__TuningStateRequest ProtobufMsgs__TuningStateRequest;
...
struct  _ProtobufMsgs__TuningStateRequest
{
  ProtobufCMessage base;
  /*
...
#define PROTOBUF_MSGS__TUNING_STATE_REQUEST__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&protobuf_msgs__tuning_state_request__descriptor) \
    , 0 }
...
void   protobuf_msgs__tuning_state__free_unpacked
                     (ProtobufMsgs__TuningState *message,
                      ProtobufCAllocator *allocator);
/* ProtobufMsgs__TuningStateRequest methods */
...
typedef void (*ProtobufMsgs__TuningState_Closure)
                 (const ProtobufMsgs__TuningState *message,
                  void *closure_data);
typedef void (*ProtobufMsgs__TuningStateRequest_Closure)
                 (const ProtobufMsgs__TuningStateRequest *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor protobuf_msgs__tuning_state_request__descriptor;

PROTOBUF_C__END_DECLS


#endif  /* PROTOBUF_C_systemmanager_2ftuningstate_2eproto__INCLUDED */
